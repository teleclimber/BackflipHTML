...
`backflip_streamRenderRoot` does **not** inject scripts (it is also used internally for nested partials); auto-include is a `backflip_renderRoot` page-level concern.
